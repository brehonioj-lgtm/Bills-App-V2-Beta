...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-200 p-4 md:p-8">
      <div className="mx-auto max-w-md px-2 md:px-0 overflow-hidden"> <div className="rounded-[34px] bg-neutral-100 shadow-2xl ring-1 ring-black/5">
        <div className="bg-[#2554A4] px-6 py-7 text-center">
