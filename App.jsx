...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-200 p-4 md:p-8">
      <div className="mx-auto max-w-md rounded-[34px] bg-neutral-100 shadow-2xl ring-1 ring-black/5">
        <div className="bg-[#2554A4] px-4 py-2.5 text-center shadow-[0_4px_10px_rgba(0,0,0,0.15)]">
